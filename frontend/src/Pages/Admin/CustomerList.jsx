...
import UserModel from "../../component/UserModel"; // Ensure this component can handle edits
  ...
  const fetchCustomers = async (page = 1, search = "") => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:8000/api/users/?role=customer&page=${page}&username=${search}`,
        {
          headers: {
    ...
    <div className="flex h-full flex-col items-center justify-center">
      <div className="h-full flex items-center flex-col bg-white rounded-t-lg w-full shadow-lg">
        <div className="flex flex-col w-full p-4 rounded-t-lg bg-[#f9f9f9] shadow">
          <h1 className="text-center text-2xl font-semibold mb-4">Customer</h1>
